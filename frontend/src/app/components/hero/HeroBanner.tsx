...
export default function HeroBanner({ onVideoOpen }: { onVideoOpen: () => void }) {
  ...
  return (
    ...
    >
      ...
      {/* ستون چپ: تصویر خورشیدی با افکت شناور */}
      <motion.div 
        variants={itemVariants}
      ...
      >
        ...
        {/* Changed max-w-md lg:max-w-lg to max-w-sm lg:max-w-md to make it visually smaller */}
        <div className="relative w-full max-w-sm lg:max-w-md">
          <motion.div 
            animate={{ y: [0, -10, 0] }} 
            transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }}
          >
            {/* Changed width and height from 600 to 400 to reduce image file size and base dimensions */}
            <Image
              src="/images/solar/main2.png" 
              alt="پنل خورشیدی پرتابل"
              width={400}
              height={400}
          ...
          >
            ...
            <div>
              <p className="text-sm font-bold text-gray-900">بازدهی بالا</p>
              <p className="text-xs text-gray-500">شارژ سریع با نور خورشید</p>
            </div>
          </motion.div>
        </div>
      </motion.div>
