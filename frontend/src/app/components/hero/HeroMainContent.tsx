  ...
  return (
    <div className="mx-auto max-w-2xl pt-12 sm:pt-16 lg:pt-24 pb-6 sm:pb-10 lg:pb-12 px-4 sm:px-6">
      <div className="hidden sm:mb-8 sm:flex sm:justify-center">
        ...
        >
          <IoPlayCircleSharp
            className="text-xl text-gray-500 transition-all duration-100 group-hover:text-orange-500
      ...
      <div className="text-center space-y-6 sm:space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <a
            href="#order"
            className="w-full sm:w-auto rounded-md bg-orange-500 px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-semibold text-white shadow-sm 
          ...
          <a
            href="#products"
            className="w-full sm:w-auto rounded-md bg-gradient-to-r from-yellow-400 to-orange-500 px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-semibold 
